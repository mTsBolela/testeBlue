...
type DischargeReceiptService struct {
	Repo financials.FinancialRepository
}

func NewDischargeReceiptService(repo financials.FinancialRepository) *DischargeReceiptService {
	return &DischargeReceiptService{repo}
}

func (service *DischargeReceiptService) Execute(financial *financials.Financial) *errs.Error {
